class HashMapCustom<K, V> { 
     ...
     private float loadfactor =.76f;// resize() after reaching the table full
     ...
     public HashMapCustom(){
       table = new Entry[capacity]; // constructor creating an Array of size 4 
    }
...
public class Interview5 {
    ...
    public static void main(String[] args) {
           ...
           hashMapCustom.put(21, 13);
           hashMapCustom.put(25, 121);
           hashMapCustom.put(25, 12);
